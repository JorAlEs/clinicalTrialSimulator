...
Each patient’s row aggregates all their relevant information. For example, if a patient died during the trial, EventStatus=1 and EventTime is when it happened; if a patient dropped out, Dropped=TRUE and DropoutTime is given (and their Outcome may be NA due to missing data from dropout).
